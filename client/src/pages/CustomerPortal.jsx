          ...
          <div className="space-y-3 md:space-y-4 w-full">
            ...
            <div className={`flex items-center ${sidebarCollapsed ? 'justify-center' : 'justify-center md:justify-between'} pb-2 border-b border-slate-850`}>
              ...
              <button
                ...
                className="p-2 rounded-xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 transition-all cursor-pointer md:hidden flex items-center justify-center shadow-md active:scale-95"
